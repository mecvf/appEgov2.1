...
class BebidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bebida" do
    assert_difference('Bebida.count') do
      post bebidas_url, params: { bebida: { nombre: @bebida.nombre, precio: @bebida.precio, tamanio: @bebida.tamanio, tipo: @bebida.tipo } }
    end
  ...
  test "should update bebida" do
    patch bebida_url(@bebida), params: { bebida: { nombre: @bebida.nombre, precio: @bebida.precio, tamanio: @bebida.tamanio, tipo: @bebida.tipo } }
